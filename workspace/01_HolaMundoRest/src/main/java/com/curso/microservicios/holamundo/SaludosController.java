...
public class SaludosController {
	...
	public ResponseEntity<SaludoOut> hola(
		...
		//SaludoIn saludoIn = restTemplate.getForObject("http://almacensaludos/Saludos/{tipo}", SaludoIn.class, uriVariables);
		
		SaludoIn saludoIn = almacenSaludos.saludos("hola");
		
		String saludo = saludoIn.getPrefijo() + " " + name + saludoIn.getSufijo();
